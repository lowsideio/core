...
type Motorcycle struct {
  ...
  RearSuspension        string      `json:"fearSuspension" string:"fearSuspension" form:"fearSuspension" query:"fearSuspension"`
  RearWheelTravel       string      `json:"fearWheelTravel" string:"fearWheelTravel" form:"fearWheelTravel" query:"fearWheelTravel"`
